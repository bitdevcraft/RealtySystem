...
@Component({
    ...
    imports: [AccordionModule, FieldsetModule, Button, Toolbar, ButtonGroupModule, TabsModule, InputText, Select, Textarea, FormsModule, FluidModule, AutoComplete, TableModule, SplitButtonModule, PanelModule, InputNumberModule, ReactiveFormsModule, NgIf, CurrencyPipe, PrefixSuffixPipe],
    styles: `
                ...
                <p-tabpanels>
                    <p-tabpanel value="0">
                        ...
                        <form [formGroup]="propertyForm">
                                            ...
                                            <div class=" flex flex-col gap-6 w-full">
                                                <div class="flex flex-col md:flex-row gap-6">
                                                    ...
                                                    <div class="flex flex-wrap flex-col gap-2 w-full">
                                                        ...
                                                        <p-autocomplete inputId="project"
                                                ...
                                                <div class="flex flex-col md:flex-row gap-6">
                                                    <div class="flex flex-wrap gap-2 w-full">
                                                        ...
                                                        <p-select id="type" formControlName="type" *ngIf="editMode"
                                                                  [options]="propertyTypes" optionLabel="name" optionValue="code"
                                                    ...
                                                    <div class="flex flex-wrap gap-2 w-full">
                                                        ...
                                                        <p-select id="listingType" formControlName="listing"
                                                                  *ngIf="editMode"
                                                                  [options]="listingTypes" optionLabel="name"  optionValue="code"
                                    ...
                                    <p-fluid>
                                        <div class="mb-4 mt-4" formGroupName="address">
                                            ...
                                            <div
                                                ...
                                                *ngIf="!editMode">
                                                <div>
                                                    {{ propertyValue.address.street }}, {{ propertyValue.address.city }}
                                                    ...
                                                    <div class="flex flex-wrap gap-2 w-full">
                                                        <div class="flex flex-wrap gap-2 w-full">
                                                            <label class="font-bold" for="originalPrice">Original
                                                                Price</label>
                                                            <p-inputnumber id="originalPrice" mode="currency" *ngIf="editMode"
                                                        ...
                                                        <div class="flex flex-wrap gap-2 w-full">
                                                            <label class="font-bold" for="listingPrice">Listing
                                                                Price</label>
                                                            <p-inputnumber inputId="listingPrice" mode="currency"  *ngIf="editMode"
                            ...
                            <p-table [value]="features" stripedRows [scrollable]="true"
                        ...
                        <div class="flex gap-2 justify-center mt-4" *ngIf="editMode">
                            <p-button label="Cancel" severity="danger" [text]="true" icon="pi pi-times" class="mr-2"
                                      (onClick)="cancelEdit()"/>
                            <p-button label="Save" variant="outlined" icon="pi pi-pencil" (onClick)="saveRecord()"/>
                        </div>
