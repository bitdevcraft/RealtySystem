            ...
            <ng-template #content>
                <div class="flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <p-autocomplete [(ngModel)]="record.community" [suggestions]="autoFilteredValue" optionLabel="name" placeholder="Search" (completeMethod)="filterCommunity($event)" fluid appendTo="body" id="community">
                            <!--                            <ng-template #footer>-->
                            <!--                                <div class="px-3 py-3">-->
